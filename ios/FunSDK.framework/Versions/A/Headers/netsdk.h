...
#define MAX_DEV_NAMEPASSWORD_LEN    80

#define MAX_DEV_TOKEN_LEN 64

#define MAX_DEV_PID 24

#define MAX_RAND_KEY 64

#define MAX_BEL_ENC_TOKEN 2048 ///< 蓝牙TOKEN

#define MAX_DEV_MULTI_MODULE_UPGRADE_NUM 16
...
#define NET_MAX_USER_LENGTH			80			//用户名密码最大长度
...
#define NET_NAME_PASSWORD_LEN		80			//用户名密码最大长度
...
enum SDK_CAPTURE_SIZE_t {
    ...
    SDK_CAPTURE_SIZE_5M,          	// 2560*1920
    SDK_CAPTURE_SIZE_NR =19,
    SDK_CAPTURE_SIZE_1080N = 19,    // 944*1080
    SDK_CAPTURE_SIZE_4M,        	// 2560*1440
    ...
    SDK_CAPTURE_SIZE_NHD_2,      		// 640*360 // SDK_CAPTURE_SIZE_NHD_1 没区别，NVR就是这样的。。
    SDK_CAPTURE_SIZE_3M_N,      		// 1024*1536
    SDK_CAPTURE_SIZE_4M_N,      		// 1280*1440
    SDK_CAPTURE_SIZE_5M_N,      		// 1280*1920
    SDK_CAPTURE_SIZE_4K_N,      		// 1920*2160
...
typedef struct SDK_CONFIG_NET_COMMON_V2
{
    ...
    char sRandomUser[8];    ///< 默认随机用户名
    char sRandomPwd[8];    ///< 默认随机密码
    char sPid[24];    ///< 产品型号
    char Resume[16];		///保留
...
/** 多模块升级信息*/
typedef struct SMultiModuleUpgradeInfo
{
    int nPartitionNum; ///< 分区数
    SDK_CloudUpgradeStartReq upgradeStartReq[MAX_DEV_MULTI_MODULE_UPGRADE_NUM];
}SMultiModuleUpgradeInfo;
