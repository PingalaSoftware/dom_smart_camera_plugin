...
typedef enum EE_MSG
{
    ...
    EMSG_ON_RECV_EVENT = 61,
    EMSG_ON_ACCEPT_EVENT = 62,
    EMSG_ON_QUERY_DNS = 63,
    EMSG_ON_UDP_SERVER_LISTEN = 64,
    EMSG_ON_RECVFROM_EVENT = 65,
...
extern Bool g_disable_extranet;
#define RETURN_IS_DISABLE_EXTRANET if(g_disable_extranet) return EE_DISABLE_CONNECT_EXTRANET
#define BREAK_IS_DISABLE_EXTRANET if(g_disable_extranet) break
...
typedef enum EE_LIB_DEF_EEORR
{
    ...
    EE_DISABLE_CONNECT_EXTRANET = -99984, // 禁止连接外网
    EE_FUNCTION_NOT_INITIALIZED = -99983, // 功能未初始化
