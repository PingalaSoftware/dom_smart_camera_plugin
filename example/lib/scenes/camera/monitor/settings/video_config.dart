...
class VideoConfig extends StatefulWidget {
  ...
  const VideoConfig({required this.cameraId, Key? key}) : super(key: key);
...
class _VideoConfigState extends State<VideoConfig> {
  ...
  void submitNewName() async {
    ...
    await _domCameraPlugin.setVideoConfig(_newNameController.text);
  ...
  void getConfig() async {
    ...
    final data = await _domCameraPlugin.getVideoConfig();
