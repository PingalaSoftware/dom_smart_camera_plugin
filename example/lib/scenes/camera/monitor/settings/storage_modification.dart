...
class StorageModification extends StatefulWidget {
  final String cameraId;

  const StorageModification({required this.cameraId, Key? key})
      : super(key: key);

  @override
  State<StorageModification> createState() => _StorageModificationState();
}

class _StorageModificationState extends State<StorageModification> {
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text('Formate Storage'),
          )
        ],
      ),
    );
  ...
  void submitNewName() async {
    ...
    await _domCameraPlugin.formatStorage();
  ...
  void getConfig() async {
    ...
    final data = await _domCameraPlugin.getStorageModifications();
