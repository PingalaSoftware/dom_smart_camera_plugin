...
class CameraInfo extends StatefulWidget {
  ...
  const CameraInfo({required this.cameraId, Key? key}) : super(key: key);

  @override
  State<CameraInfo> createState() => _CameraInfoState();
}
...
class _CameraInfoState extends State<CameraInfo> {
  ...
  void submitNewName() async {
    ...
    await _domCameraPlugin.setCameraInfo(_newNameController.text);
  ...
  void getConfig() async {
    ...
    final data = await _domCameraPlugin.getCameraInfo();
