...
class EncodingConfig extends StatefulWidget {
  final String cameraId;

  const EncodingConfig({required this.cameraId, Key? key}) : super(key: key);

  @override
  State<EncodingConfig> createState() => _EncodingConfigState();
}

class _EncodingConfigState extends State<EncodingConfig> {
  ...
  void submitNewName() async {
    ...
    await _domCameraPlugin.setEncodingConfig(_newNameController.text);
  ...
  void getConfig() async {
    ...
    final data = await _domCameraPlugin.getEncodingConfig();
