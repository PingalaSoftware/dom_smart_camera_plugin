...
class AlarmConfigHuman extends StatefulWidget {
  final String cameraId;

  const AlarmConfigHuman({required this.cameraId, Key? key}) : super(key: key);

  @override
  State<AlarmConfigHuman> createState() => _AlarmConfigHumanState();
}

class _AlarmConfigHumanState extends State<AlarmConfigHuman> {
  ...
  void submitNewName() async {
    ...
    await _domCameraPlugin.setHumanDetectConfig(_newNameController.text);
  ...
  void getConfig() async {
    ...
    final data = await _domCameraPlugin.getHumanDetectConfig();
